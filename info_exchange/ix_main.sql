...
DEFINE ttbs     = &3
PROMPT
PROMPT specify password for ADMIN as parameter 4:
DEFINE pass_main = &4
PROMPT
...
CONNECT admin/&pass_main@&connect_string;
...
BEGIN
 ...
 IF (v = 'v2') OR (v = 'v3') THEN
   ...
   DBMS_RULE_ADM.GRANT_SYSTEM_PRIVILEGE(
    ...
    grantee      => 'ix',
    grant_option => FALSE);
  -- trent: The queue stuff doesn't seem to work. Look into this in the future
