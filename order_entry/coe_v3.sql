...
DEFINE pwd_oe  = &2
PROMPT
PROMPT PROMPT password for ADMIN as parameter 3:
DEFINE pass_admin = &3
PROMPT
...
-- trent: For Autonomous DB, this query grants XDBADMIN, which is seemingly unavailable
-- so just skipping XMLDB step
-- @__SUB__CWD__/order_entry/coe_xml.sql &pwd_oe &pass_admin &connect_string
